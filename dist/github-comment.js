...
export async function maybePostGitHubComment(results, limit) {
    ...
    if (existing) {
        await githubRequest(`https://api.github.com/repos/${pr.owner}/${pr.repo}/issues/comments/${existing.id}`, { method: 'PATCH', body: JSON.stringify({ body }) }, token);
        return;
    }
